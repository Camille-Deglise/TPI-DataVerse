...
@guest
    <div class="">
        <form class="w-full max-w-sm mx-auto pt-2" action="{{route('login')}}" method="POST">
            @csrf
        ...
        <div class="font-cali">
            <a href="{{route('password.request')}}" class=" text-gray-600 hover:text-cyan-700 hover:font-bold px-3 py-2 rounded-md  text-sm ">Mot de passe oublié ?</a>
            <a href="{{ route('register') }}" class=" text-gray-600 hover:text-cyan-700 hover:font-bold px-3 py-2 rounded-md text-sm ">Pas encore inscrit ?</a>
        </div>
    </div>  
